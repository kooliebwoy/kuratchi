  ...
  <div class="w-full max-w-md">
    ...
    <div class="rounded-lg border border-base-300 bg-base-100 shadow-lg overflow-hidden">
      <div class="px-6 py-8">
        <!-- Header -->
        <div class="mb-6">
          <h1 class="text-2xl font-bold tracking-tight">Sign In to Kuratchi</h1>
          <p class="text-sm text-base-content/60 mt-2">Access your database management console</p>
        </div>
      ...
      <div class="px-6 py-4 border-t border-base-300 bg-base-200/30 text-center">
        <p class="text-sm text-base-content/70">
          ...
          <a href="/auth/signup" class="font-medium text-base-content hover:underline">Sign up</a>
        </p>
      </div>
    </div>
  </div>
